...
class TypeWriterEffect extends Component {
    ...
    multiTextDisplay = async (arr: string | any[]) => {
    ...
    runAnimation = async (str: string, erase: number | undefined) => {
    ...
    eraseText = async (str: string) => {
        const textArr: string[] = str.trim().split('');
        this.setState({
            blink: false,
        });
        let text = str.trim();
